...
from VolatilityModels import RobustQLEModel, Beta_t_GARCH11
...
def simulate_scale_dgp_obs_outliers(
    ...
    contam_where="train",  # "train", "test", "both"
    seed=0,
):
    """
...
def run_one_simulation_scale_train_contaminated(
    ...
    (
        ...
        outlier_dist="t",
        outlier_df=3,
        contam_where="both",     # Which part of the sample to contaminate: "train", "test", or "both"
        seed=seed
    )
