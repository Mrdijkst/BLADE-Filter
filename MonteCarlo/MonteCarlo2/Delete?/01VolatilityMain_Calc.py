...
# -*- coding: utf-8 -*-
"""
Purpose: Mainfile Volatility Experiments MC
"""
...
# Dependencies
from VolatilityExperiment import *
from Basis import *
...
def main():    
    ...
    # Main parameter
    dEps = float(sExperiment.split('_')[0][3:])# extract eps from experiment name
    dNu = 10
    ...
    vGamma1Grid = np.linspace(-4.0, 2.0, iLenGamma1Grid)
